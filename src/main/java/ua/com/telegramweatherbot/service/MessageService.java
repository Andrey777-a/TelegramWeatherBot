...
public interface MessageService {
    ...
    void sendWeatherInfo(long chatId, String localNameCity, WeatherResponse weatherResponse, String unit);

    void sendWeatherInfo(long chatId, WeatherResponse weatherResponse, String unit);
